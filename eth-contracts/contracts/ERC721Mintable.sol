...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(
            newOwner != address(0),
            "Address of new owner is not real address"
        );
        _owner = newOwner;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            to != ownerOf(tokenId),
            "Given address cannot be owner of the tokenId"
        );
        ...
        require(
            ...
            "Should be owner of the contract or approvedForAll()"
        );
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
        ...
        require(approvalAddress != address(0), "No token approval");
    ...
    function _transferFrom(
        ...
        require(
            ...
            "Given owner does not own this token"
        );
